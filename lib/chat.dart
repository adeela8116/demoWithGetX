                    ...
                    child:Container(
                        ...
                        child:  SingleChildScrollView(
                          child: Obx(() {
                            ...
                            for(ChatMessage msg in c.messages){
                              chatWidget.add(
                                Container(
                                  padding: EdgeInsets.only(left: 14,right: 14,top: 10,bottom: 10),
                                  child: Align(
                                    alignment: (msg.messageType == "receiver"?Alignment.topLeft:Alignment.topRight),
                                    child: Container(
                                      decoration: BoxDecoration(
                                        borderRadius:
                                        msg.messageType  == "receiver"? BorderRadius.only(
                                        ...
                                        color: (msg.messageType  == "receiver"?Colors.grey.shade600:Colors.blueAccent),
                                      ),
